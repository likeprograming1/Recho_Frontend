...
const SignUp = () => {
  ...
  const onChangeEmail = (e) => {
    ...
    const emailRegExp = /^(?=.*[a-zA-Z])(?=.*\d)[a-zA-Z\d]{1,20}$/;
    ...
    <SignUpBox>
      ...
      <section className="namepsbar namebar">
        ...
        <input
          ...
          placeholder={nameInputClick === true ? "" : "실명을 입력해주세요"}
        ></input>
        <h5>특수문자 제외 10자이하</h5>
      </section>
      ...
      <section className="emailbar">
        ...
        <input
          ...
          placeholder={emailInputClick === true ? "" : "이메일을 입력해주세요"}
        ></input>
        <input
          type="email"
          name="email"
      ...
      <section className="nickbar">
        ...
        <input
          ...
          placeholder={nickInputClick === true ? "" : "닉네임을 입력해주세요"}
        ></input>
        <h5>특수문자 제외 10자이하</h5>
      </section>
      ...
      <section className="check">
        ...
        <div className="corcheck">
          ...
          <label htmlFor="correct">개인정보 수집 및 이용동의</label>
        </div>
      </section>
      <section className="signbutton">
        <button onClick={openArtistModalHandler}>아티스트 가입하기</button>
        {isOpen ? (
